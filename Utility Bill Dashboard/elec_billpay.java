...
public class elec_billpay extends JFrame implements ActionListener
{
...
int bs=0;
ResultSet rs;
rs=s11.executeQuery("select * from electricity where flat_no=" + Integer.parseInt(t1.getText()));
while(rs.next())
{
...
if(rs.getString(15).equals("paid"))
{
bs=1;
jp.showMessageDialog(this,"Your Bill is already paid");
}
count++;
break;
}
...
Connection con=DriverManager.getConnection("jdbc:odbc:bill_project");
Statement s11=con.createStatement();
s11.executeUpdate("update electricity set status='paid' where flat_no=" + Integer.parseInt(t1.getText()));
jp.showMessageDialog(this,"Your Bill is Paid Now");
}
catch(Exception ee)
{
jp.showMessageDialog(this,ee.getMessage());
...
{
elec_billpay na=new elec_billpay();
}
}