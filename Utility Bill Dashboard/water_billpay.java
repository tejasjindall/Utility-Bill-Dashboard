...
public class water_billpay extends JFrame implements ActionListener
{
...
Connection con=DriverManager.getConnection("jdbc:odbc:bill_project");
Statement s11=con.createStatement();
s11.executeUpdate("update water set status='paid' where flat_no=" + Integer.parseInt(t1.getText()));
...
{
water_billpay na=new water_billpay();
}
}